                            ...
                            <div className='flex flex-col gap-4'>
                                {screen === 'detailedAnalysis' && (
                                    <div className='text-sm'>
                                        ...
                                        <p className='mb-2.5 mt-1.5 italic text-zinc-800/90 dark:text-zinc-200/95'>{` *The contents of the AI Response and Citation(s) columns were not generated by Artificial Intelligence.`}</p>
                                        <DetailedAnalysis
                                            excelData={excelData}
                                            llmResponse={llmResponse}
